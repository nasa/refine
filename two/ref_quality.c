				...
				REF_DBL *volume)
{
  ...
  *volume = 0.0;
  ...
  RSS( ref_cell_nodes( ref_grid_tet(ref_grid), cell, nodes), "cell missing");

  a = &ref_node_xyz(ref_grid_node(ref_grid),0,nodes[0]);
  b = &ref_node_xyz(ref_grid_node(ref_grid),0,nodes[1]);
  c = &ref_node_xyz(ref_grid_node(ref_grid),0,nodes[2]);
  d = &ref_node_xyz(ref_grid_node(ref_grid),0,nodes[3]);
