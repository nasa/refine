...
( cd parmetis && \
    ...
    CC=mpicc \
    FC=mpif90 \
    CFLAGS='-DHAVE_MPI -g -O2 -traceback -Wall -w3 -wd1418,2259,2547,981,11074,11076 -ftrapuv' \
    ) \
    || exit
...
( cd zoltan && \
    ...
    CC=mpicc \
    FC=mpif90 \
    CFLAGS='-DHAVE_MPI -g -O2 -traceback -Wall -w3 -wd1418,2259,2547,981,11074,11076,47 -ftrapuv' \
    ) \
    || exit
