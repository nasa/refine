...
module load ESP/119-beta.2020.07.22.1007
...
export egads_path="${module_path}/ESP/119-beta.2020.07.22.1007/EngSketchPad"
export opencascade_path="${module_path}/ESP/119-beta.2020.07.22.1007/OpenCASCADE-7.3.1"
