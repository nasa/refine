...
function adapt_cycle {
    ...
    mpiexec -np 4 ${two}/ref_driver -i ${proj}.lb8.ugrid -m ${proj}.solb -s ${sweeps} -x ref_adapt_test.lb8.ugrid
...
adapt_cycle accept-3d-linear-mpt-00 10
adapt_cycle accept-3d-linear-mpt-01 20
adapt_cycle accept-3d-linear-mpt-02 10
adapt_cycle accept-3d-linear-mpt-03 10
