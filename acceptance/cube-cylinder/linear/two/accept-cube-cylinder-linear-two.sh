...
function adapt_cycle_sant {
    ...
    ${two}/ref_driver -i ${inproj}.meshb -g ega.egads -p ${inproj}.gas -m ${inproj}.metric -o ${outproj} -s ${sweeps} -l
...
function adapt_cycle {
    ...
    ${two}/ref_driver -i ${inproj}.meshb -g ega.egads -p ${inproj}.gas -m ${inproj}.metric -o ${outproj} -s ${sweeps}
    ${two}/ref_acceptance -ugawg ${field} ${outproj}.meshb ${outproj}.metric
    ${two}/ref_metric_test ${outproj}.meshb ${outproj}.metric > ${outproj}.status
