...
struct Grid {
  ...
  double min_allowed_swap_cost;
  double min_allowed_swap_cost_improvement;
...
Grid *gridExportOFF(Grid *g, char *filename );
...
Grid *gridWriteTecplotVolumeGeom(Grid *g, char *filename );
Grid *gridWriteTecplotGeomFaceUV(Grid *g, char *filename, int id );
Grid *gridWriteTecplotGeomFaceXYZ(Grid *g, char *filename, int id );
Grid *gridWriteTecplotTriangleZone(Grid *g, char *filename, char *zone,
...
Grid *gridSetMinSwapCost(Grid *g, double min_cost );
double gridMinSwapCost(Grid *g );

Grid *gridSetMinSwapCostImprovement(Grid *g, double min_cost );
double gridMinSwapCostImprovement(Grid *g );
