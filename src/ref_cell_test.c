...
int main(int argc, char *argv[]) {
  ...
  { /* edg */
    ...
    bary[0] = 1.0;
    bary[1] = 0.0;
    RSS(ref_cell_shape(ref_cell_type(ref_cell), bary, shape), "shape");
  ...
  { /* ed3 */
    REF_CELL ref_cell;
    REF_DBL bary[2], shape[4];
    RSS(ref_cell_create(&ref_cell, REF_CELL_ED3), "ed3");
    bary[0] = 1.0;
    bary[1] = 0.0;
    RSS(ref_cell_shape(ref_cell_type(ref_cell), bary, shape), "shape");
    RWDS(1.0, shape[0], -1, "s0");
  ...
  { /* tr3 */
    REF_CELL ref_cell;
    REF_DBL bary[3], shape[10];
    RSS(ref_cell_create(&ref_cell, REF_CELL_TR3), "tr3");
    bary[0] = 1.0;
    bary[1] = 0.0;
    bary[2] = 0.0;
    RSS(ref_cell_shape(ref_cell_type(ref_cell), bary, shape), "shape");
    ...
    RWDS(0.0, shape[4], -1, "s4");
    RWDS(0.0, shape[5], -1, "s5");
    RWDS(0.0, shape[6], -1, "s6");
    RWDS(0.0, shape[7], -1, "s7");
    RWDS(0.0, shape[8], -1, "s8");
    RWDS(0.0, shape[9], -1, "s9");
    bary[0] = 0.0;
    bary[1] = 1.0;
    bary[2] = 0.0;
    RSS(ref_cell_shape(ref_cell_type(ref_cell), bary, shape), "shape");
