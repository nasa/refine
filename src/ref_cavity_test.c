...
int main(int argc, char *argv[]) {
  ...
  if (!ref_mpi_para(ref_mpi)) { /* add triangle adds faces*/
    REF_GRID ref_grid;
    REF_CAVITY ref_cavity;
    REF_INT nodes[2];
    REF_INT face;
  ...
  if (!ref_mpi_para(ref_mpi)) { /* add rm triangle counts */
    REF_GRID ref_grid;
    REF_CAVITY ref_cavity;
  ...
  if (!ref_mpi_para(ref_mpi)) { /* insert tri node */
    REF_GRID ref_grid;
    REF_NODE ref_node;
    REF_CAVITY ref_cavity;
  ...
  if (!ref_mpi_para(ref_mpi)) { /* visible two node face */
    REF_GRID ref_grid;
    REF_NODE ref_node;
    REF_CAVITY ref_cavity;
    REF_INT global, node, face;
    ...
    ref_node_xyz(ref_node, 2, node) = 0.3;
    face = 0;
    RSS(ref_cavity_visible(ref_cavity, ref_node, node, face, &visible), "viz");
    REIS(REF_TRUE, visible, "vis");
  ...
  if (!ref_mpi_para(ref_mpi)) { /* insert and remove tri node */
    REF_GRID ref_grid;
    REF_NODE ref_node;
    REF_CAVITY ref_cavity;
