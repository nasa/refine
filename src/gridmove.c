...
GridMove *gridmoveElasticRelax_Old_StartStep(GridMove *gm, double position)
{
  Grid *grid = gridmoveGrid(gm);
  int i;
  int cell, nodes[4];
...
GridMove *gridmoveElasticRelaxationStartStep(GridMove *gm, double position)
{
  ...
  for(cell=0;cell<gridMaxCell(grid);cell++){
    if (grid==gridCell(grid,cell,nodes)) {
      ...
      aspect_ratio = gridCellAspectRatio( xyz1, xyz2, xyz3, xyz4 );

      if ( aspect_ratio > 1.0e-8 ) {
	...
	poisson * modulus_of_elasticity / (1.0 + poisson) / (1.0 - 2.0*poisson);
      ...
      gm->a[0+idiag1] = gm->a[0+idiag1] + muterm + xlambda*c1x + xmu*c1x;
      gm->a[1+idiag1] = gm->a[1+idiag1]          + xlambda*c1y + ymu*c1x;
      gm->a[2+idiag1] = gm->a[2+idiag1]          + xlambda*c1z + zmu*c1x;
      gm->a[3+idiag1] = gm->a[3+idiag1]          + ylambda*c1x + xmu*c1y;
      gm->a[4+idiag1] = gm->a[4+idiag1] + muterm + ylambda*c1y + ymu*c1y;
      gm->a[5+idiag1] = gm->a[5+idiag1]          + ylambda*c1z + zmu*c1y;
      gm->a[6+idiag1] = gm->a[6+idiag1]          + zlambda*c1x + xmu*c1z;
      gm->a[7+idiag1] = gm->a[7+idiag1]          + zlambda*c1y + ymu*c1z;
      gm->a[8+idiag1] = gm->a[8+idiag1] + muterm + zlambda*c1z + zmu*c1z;

      muterm = mu*(xn*c2x + yn*c2y + zn*c2z);

      gm->a[0+ioff12] = gm->a[0+ioff12] + muterm + xlambda*c2x + xmu*c2x;
      gm->a[1+ioff12] = gm->a[1+ioff12]          + xlambda*c2y + ymu*c2x;
      gm->a[2+ioff12] = gm->a[2+ioff12]          + xlambda*c2z + zmu*c2x;
      gm->a[3+ioff12] = gm->a[3+ioff12]          + ylambda*c2x + xmu*c2y;
      gm->a[4+ioff12] = gm->a[4+ioff12] + muterm + ylambda*c2y + ymu*c2y;
      gm->a[5+ioff12] = gm->a[5+ioff12]          + ylambda*c2z + zmu*c2y;
      gm->a[6+ioff12] = gm->a[6+ioff12]          + zlambda*c2x + xmu*c2z;
      gm->a[7+ioff12] = gm->a[7+ioff12]          + zlambda*c2y + ymu*c2z;
      gm->a[8+ioff12] = gm->a[8+ioff12] + muterm + zlambda*c2z + zmu*c2z;

      muterm = mu*(xn*c3x + yn*c3y + zn*c3z);

      gm->a[0+ioff13] = gm->a[0+ioff13] + muterm + xlambda*c3x + xmu*c3x;
      gm->a[1+ioff13] = gm->a[1+ioff13]          + xlambda*c3y + ymu*c3x;
      gm->a[2+ioff13] = gm->a[2+ioff13]          + xlambda*c3z + zmu*c3x;
      gm->a[3+ioff13] = gm->a[3+ioff13]          + ylambda*c3x + xmu*c3y;
      gm->a[4+ioff13] = gm->a[4+ioff13] + muterm + ylambda*c3y + ymu*c3y;
      gm->a[5+ioff13] = gm->a[5+ioff13]          + ylambda*c3z + zmu*c3y;
      gm->a[6+ioff13] = gm->a[6+ioff13]          + zlambda*c3x + xmu*c3z;
      gm->a[7+ioff13] = gm->a[7+ioff13]          + zlambda*c3y + ymu*c3z;
      gm->a[8+ioff13] = gm->a[8+ioff13] + muterm + zlambda*c3z + zmu*c3z;

      muterm = mu*(xn*c4x + yn*c4y + zn*c4z);

      gm->a[0+ioff14] = gm->a[0+ioff14] + muterm + xlambda*c4x + xmu*c4x;
      gm->a[1+ioff14] = gm->a[1+ioff14]          + xlambda*c4y + ymu*c4x;
      gm->a[2+ioff14] = gm->a[2+ioff14]          + xlambda*c4z + zmu*c4x;
      gm->a[3+ioff14] = gm->a[3+ioff14]          + ylambda*c4x + xmu*c4y;
      gm->a[4+ioff14] = gm->a[4+ioff14] + muterm + ylambda*c4y + ymu*c4y;
      gm->a[5+ioff14] = gm->a[5+ioff14]          + ylambda*c4z + zmu*c4y;
      gm->a[6+ioff14] = gm->a[6+ioff14]          + zlambda*c4x + xmu*c4z;
      gm->a[7+ioff14] = gm->a[7+ioff14]          + zlambda*c4y + ymu*c4z;
      gm->a[8+ioff14] = gm->a[8+ioff14] + muterm + zlambda*c4z + zmu*c4z;
      ...
      gm->a[0+idiag2] = gm->a[0+idiag2] + muterm + xlambda*c2x + xmu*c2x;
      gm->a[1+idiag2] = gm->a[1+idiag2]          + xlambda*c2y + ymu*c2x;
      gm->a[2+idiag2] = gm->a[2+idiag2]          + xlambda*c2z + zmu*c2x;
      gm->a[3+idiag2] = gm->a[3+idiag2]          + ylambda*c2x + xmu*c2y;
      gm->a[4+idiag2] = gm->a[4+idiag2] + muterm + ylambda*c2y + ymu*c2y;
      gm->a[5+idiag2] = gm->a[5+idiag2]          + ylambda*c2z + zmu*c2y;
      gm->a[6+idiag2] = gm->a[6+idiag2]          + zlambda*c2x + xmu*c2z;
      gm->a[7+idiag2] = gm->a[7+idiag2]          + zlambda*c2y + ymu*c2z;
      gm->a[8+idiag2] = gm->a[8+idiag2] + muterm + zlambda*c2z + zmu*c2z;

      muterm = mu*(xn*c3x + yn*c3y + zn*c3z);

      gm->a[0+ioff23] = gm->a[0+ioff23] + muterm + xlambda*c3x + xmu*c3x;
      gm->a[1+ioff23] = gm->a[1+ioff23]          + xlambda*c3y + ymu*c3x;
      gm->a[2+ioff23] = gm->a[2+ioff23]          + xlambda*c3z + zmu*c3x;
      gm->a[3+ioff23] = gm->a[3+ioff23]          + ylambda*c3x + xmu*c3y;
      gm->a[4+ioff23] = gm->a[4+ioff23] + muterm + ylambda*c3y + ymu*c3y;
      gm->a[5+ioff23] = gm->a[5+ioff23]          + ylambda*c3z + zmu*c3y;
      gm->a[6+ioff23] = gm->a[6+ioff23]          + zlambda*c3x + xmu*c3z;
      gm->a[7+ioff23] = gm->a[7+ioff23]          + zlambda*c3y + ymu*c3z;
      gm->a[8+ioff23] = gm->a[8+ioff23] + muterm + zlambda*c3z + zmu*c3z;

      muterm = mu*(xn*c4x + yn*c4y + zn*c4z);

      gm->a[0+ioff24] = gm->a[0+ioff24] + muterm + xlambda*c4x + xmu*c4x;
      gm->a[1+ioff24] = gm->a[1+ioff24]          + xlambda*c4y + ymu*c4x;
      gm->a[2+ioff24] = gm->a[2+ioff24]          + xlambda*c4z + zmu*c4x;
      gm->a[3+ioff24] = gm->a[3+ioff24]          + ylambda*c4x + xmu*c4y;
      gm->a[4+ioff24] = gm->a[4+ioff24] + muterm + ylambda*c4y + ymu*c4y;
      gm->a[5+ioff24] = gm->a[5+ioff24]          + ylambda*c4z + zmu*c4y;
      gm->a[6+ioff24] = gm->a[6+ioff24]          + zlambda*c4x + xmu*c4z;
      gm->a[7+ioff24] = gm->a[7+ioff24]          + zlambda*c4y + ymu*c4z;
      gm->a[8+ioff24] = gm->a[8+ioff24] + muterm + zlambda*c4z + zmu*c4z;

      muterm = mu*(xn*c1x + yn*c1y + zn*c1z);

      gm->a[0+ioff21] = gm->a[0+ioff21] + muterm + xlambda*c1x + xmu*c1x;
      gm->a[1+ioff21] = gm->a[1+ioff21]          + xlambda*c1y + ymu*c1x;
      gm->a[2+ioff21] = gm->a[2+ioff21]          + xlambda*c1z + zmu*c1x;
      gm->a[3+ioff21] = gm->a[3+ioff21]          + ylambda*c1x + xmu*c1y;
      gm->a[4+ioff21] = gm->a[4+ioff21] + muterm + ylambda*c1y + ymu*c1y;
      gm->a[5+ioff21] = gm->a[5+ioff21]          + ylambda*c1z + zmu*c1y;
      gm->a[6+ioff21] = gm->a[6+ioff21]          + zlambda*c1x + xmu*c1z;
      gm->a[7+ioff21] = gm->a[7+ioff21]          + zlambda*c1y + ymu*c1z;
      gm->a[8+ioff21] = gm->a[8+ioff21] + muterm + zlambda*c1z + zmu*c1z;
      ...
      gm->a[0+idiag3] = gm->a[0+idiag3] + muterm + xlambda*c3x + xmu*c3x;
      gm->a[1+idiag3] = gm->a[1+idiag3]          + xlambda*c3y + ymu*c3x;
      gm->a[2+idiag3] = gm->a[2+idiag3]          + xlambda*c3z + zmu*c3x;
      gm->a[3+idiag3] = gm->a[3+idiag3]          + ylambda*c3x + xmu*c3y;
      gm->a[4+idiag3] = gm->a[4+idiag3] + muterm + ylambda*c3y + ymu*c3y;
      gm->a[5+idiag3] = gm->a[5+idiag3]          + ylambda*c3z + zmu*c3y;
      gm->a[6+idiag3] = gm->a[6+idiag3]          + zlambda*c3x + xmu*c3z;
      gm->a[7+idiag3] = gm->a[7+idiag3]          + zlambda*c3y + ymu*c3z;
      gm->a[8+idiag3] = gm->a[8+idiag3] + muterm + zlambda*c3z + zmu*c3z;

      muterm = mu*(xn*c4x + yn*c4y + zn*c4z);

      gm->a[0+ioff34] = gm->a[0+ioff34] + muterm + xlambda*c4x + xmu*c4x;
      gm->a[1+ioff34] = gm->a[1+ioff34]          + xlambda*c4y + ymu*c4x;
      gm->a[2+ioff34] = gm->a[2+ioff34]          + xlambda*c4z + zmu*c4x;
      gm->a[3+ioff34] = gm->a[3+ioff34]          + ylambda*c4x + xmu*c4y;
      gm->a[4+ioff34] = gm->a[4+ioff34] + muterm + ylambda*c4y + ymu*c4y;
      gm->a[5+ioff34] = gm->a[5+ioff34]          + ylambda*c4z + zmu*c4y;
      gm->a[6+ioff34] = gm->a[6+ioff34]          + zlambda*c4x + xmu*c4z;
      gm->a[7+ioff34] = gm->a[7+ioff34]          + zlambda*c4y + ymu*c4z;
      gm->a[8+ioff34] = gm->a[8+ioff34] + muterm + zlambda*c4z + zmu*c4z;

      muterm = mu*(xn*c1x + yn*c1y + zn*c1z);

      gm->a[0+ioff31] = gm->a[0+ioff31] + muterm + xlambda*c1x + xmu*c1x;
      gm->a[1+ioff31] = gm->a[1+ioff31]          + xlambda*c1y + ymu*c1x;
      gm->a[2+ioff31] = gm->a[2+ioff31]          + xlambda*c1z + zmu*c1x;
      gm->a[3+ioff31] = gm->a[3+ioff31]          + ylambda*c1x + xmu*c1y;
      gm->a[4+ioff31] = gm->a[4+ioff31] + muterm + ylambda*c1y + ymu*c1y;
      gm->a[5+ioff31] = gm->a[5+ioff31]          + ylambda*c1z + zmu*c1y;
      gm->a[6+ioff31] = gm->a[6+ioff31]          + zlambda*c1x + xmu*c1z;
      gm->a[7+ioff31] = gm->a[7+ioff31]          + zlambda*c1y + ymu*c1z;
      gm->a[8+ioff31] = gm->a[8+ioff31] + muterm + zlambda*c1z + zmu*c1z;

      muterm = mu*(xn*c2x + yn*c2y + zn*c2z);

      gm->a[0+ioff32] = gm->a[0+ioff32] + muterm + xlambda*c2x + xmu*c2x;
      gm->a[1+ioff32] = gm->a[1+ioff32]          + xlambda*c2y + ymu*c2x;
      gm->a[2+ioff32] = gm->a[2+ioff32]          + xlambda*c2z + zmu*c2x;
      gm->a[3+ioff32] = gm->a[3+ioff32]          + ylambda*c2x + xmu*c2y;
      gm->a[4+ioff32] = gm->a[4+ioff32] + muterm + ylambda*c2y + ymu*c2y;
      gm->a[5+ioff32] = gm->a[5+ioff32]          + ylambda*c2z + zmu*c2y;
      gm->a[6+ioff32] = gm->a[6+ioff32]          + zlambda*c2x + xmu*c2z;
      gm->a[7+ioff32] = gm->a[7+ioff32]          + zlambda*c2y + ymu*c2z;
      gm->a[8+ioff32] = gm->a[8+ioff32] + muterm + zlambda*c2z + zmu*c2z;
      ...
      gm->a[0+idiag4] = gm->a[0+idiag4] + muterm + xlambda*c4x + xmu*c4x;
      gm->a[1+idiag4] = gm->a[1+idiag4]          + xlambda*c4y + ymu*c4x;
      gm->a[2+idiag4] = gm->a[2+idiag4]          + xlambda*c4z + zmu*c4x;
      gm->a[3+idiag4] = gm->a[3+idiag4]          + ylambda*c4x + xmu*c4y;
      gm->a[4+idiag4] = gm->a[4+idiag4] + muterm + ylambda*c4y + ymu*c4y;
      gm->a[5+idiag4] = gm->a[5+idiag4]          + ylambda*c4z + zmu*c4y;
      gm->a[6+idiag4] = gm->a[6+idiag4]          + zlambda*c4x + xmu*c4z;
      gm->a[7+idiag4] = gm->a[7+idiag4]          + zlambda*c4y + ymu*c4z;
      gm->a[8+idiag4] = gm->a[8+idiag4] + muterm + zlambda*c4z + zmu*c4z;

      muterm = mu*(xn*c1x + yn*c1y + zn*c1z);

      gm->a[0+ioff41] = gm->a[0+ioff41] + muterm + xlambda*c1x + xmu*c1x;
      gm->a[1+ioff41] = gm->a[1+ioff41]          + xlambda*c1y + ymu*c1x;
      gm->a[2+ioff41] = gm->a[2+ioff41]          + xlambda*c1z + zmu*c1x;
      gm->a[3+ioff41] = gm->a[3+ioff41]          + ylambda*c1x + xmu*c1y;
      gm->a[4+ioff41] = gm->a[4+ioff41] + muterm + ylambda*c1y + ymu*c1y;
      gm->a[5+ioff41] = gm->a[5+ioff41]          + ylambda*c1z + zmu*c1y;
      gm->a[6+ioff41] = gm->a[6+ioff41]          + zlambda*c1x + xmu*c1z;
      gm->a[7+ioff41] = gm->a[7+ioff41]          + zlambda*c1y + ymu*c1z;
      gm->a[8+ioff41] = gm->a[8+ioff41] + muterm + zlambda*c1z + zmu*c1z;

      muterm = mu*(xn*c2x + yn*c2y + zn*c2z);

      gm->a[0+ioff42] = gm->a[0+ioff42] + muterm + xlambda*c2x + xmu*c2x;
      gm->a[1+ioff42] = gm->a[1+ioff42]          + xlambda*c2y + ymu*c2x;
      gm->a[2+ioff42] = gm->a[2+ioff42]          + xlambda*c2z + zmu*c2x;
      gm->a[3+ioff42] = gm->a[3+ioff42]          + ylambda*c2x + xmu*c2y;
      gm->a[4+ioff42] = gm->a[4+ioff42] + muterm + ylambda*c2y + ymu*c2y;
      gm->a[5+ioff42] = gm->a[5+ioff42]          + ylambda*c2z + zmu*c2y;
      gm->a[6+ioff42] = gm->a[6+ioff42]          + zlambda*c2x + xmu*c2z;
      gm->a[7+ioff42] = gm->a[7+ioff42]          + zlambda*c2y + ymu*c2z;
      gm->a[8+ioff42] = gm->a[8+ioff42] + muterm + zlambda*c2z + zmu*c2z;

      muterm = mu*(xn*c3x + yn*c3y + zn*c3z);

      gm->a[0+ioff43] = gm->a[0+ioff43] + muterm + xlambda*c3x + xmu*c3x;
      gm->a[1+ioff43] = gm->a[1+ioff43]          + xlambda*c3y + ymu*c3x;
      gm->a[2+ioff43] = gm->a[2+ioff43]          + xlambda*c3z + zmu*c3x;
      gm->a[3+ioff43] = gm->a[3+ioff43]          + ylambda*c3x + xmu*c3y;
      gm->a[4+ioff43] = gm->a[4+ioff43] + muterm + ylambda*c3y + ymu*c3y;
      gm->a[5+ioff43] = gm->a[5+ioff43]          + ylambda*c3z + zmu*c3y;
      gm->a[6+ioff43] = gm->a[6+ioff43]          + zlambda*c3x + xmu*c3z;
      gm->a[7+ioff43] = gm->a[7+ioff43]          + zlambda*c3y + ymu*c3z;
      gm->a[8+ioff43] = gm->a[8+ioff43] + muterm + zlambda*c3z + zmu*c3z;
    }
  }
...
GridMove *gridmoveElasticRelaxationEvenOdd(GridMove *gm, double *residual2)
{
  Grid *grid = gridmoveGrid(gm);
  int color, ncolor;
  int row, entry, col, i;
