...
mkdir -p mpi
( cd mpi && ../configure --prefix=`pwd` CC=mpicc CFLAGS='-DHAVE_MPI -g -O2 -traceback -check -check noarg_temp_created -ftrapuv -fp-stack-check -fpe0' TESTS_ENVIRONMENT='valgrind --quiet --leak-check=full' )
